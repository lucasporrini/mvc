      ...
      <div class="mt-7 bg-white border border-gray-200 rounded-xl shadow-sm dark:bg-gray-800 dark:border-gray-700">
        <div class="p-4 sm:p-7">
          <div class="text-center">
            <h1 class="block text-2xl font-bold text-gray-800 dark:text-white"><?= $this->e($title_in_page) ?></h1>
            ...
            <form>
              <div class="grid gap-y-4">
                ...
                <div>
                  ...
                  <p class="hidden text-xs text-red-600 mt-2" id="email-error">Veuillez indiquer une adresse électronique valide.</p>
                </div>
                <!-- End Form Group -->
                ...
                <div>
                  ...
                  <p class="hidden text-xs text-red-600 mt-2" id="password-error">+ de 8 caractères requis</p>
                </div>
                <!-- End Form Group -->

                <!-- Form Group -->
                <div>
                  <label for="confirm-password" class="block text-sm mb-2 dark:text-white">Confirmer mot de passe</label>
                  <div class="relative">
                  ...
                  <p class="hidden text-xs text-red-600 mt-2" id="confirm-password-error">Les mots de passe ne correspondent pas</p>
                </div>
                <!-- End Form Group -->
                ...
                <div class="flex items-center">
                  ...
                  <div class="ms-3">
                    <label for="remember-me" class="text-sm dark:text-white">J'accepte les <a class="text-blue-600 decoration-2 hover:underline font-medium dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="#">conditions d'utilisations</a></label>
                  </div>
                </div>
                <!-- End Checkbox -->
