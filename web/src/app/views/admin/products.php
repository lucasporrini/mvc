...
<div class="w-full pt-10 px-4 sm:px-6 md:px-8 lg:ps-72">
    <?php count($_GET) > 2 && isset($_GET['action']) ? $action = strval($_GET['action']) : $action = null; ?>
    <!-- Page Tabs -->
    <ul class="flex flex-wrap text-sm font-medium text-center text-gray-500 border-b border-gray-200 dark:border-gray-700 dark:text-gray-400">
        ...
        <li class="me-2">
            <a href="?page=delete" class="inline-block p-4 rounded-t-lg <?= $_GET['page'] == 'delete' || $action == 'delete' ? 'text-blue-600 bg-gray-100 active' : 'hover:text-gray-600 hover:bg-gray-50' ?>">Supprimer un produit</a>
        </li>
    </ul>
    <!-- End Page Tabs -->
