            ...
            <div class="relative z-10 lg:grid lg:grid-cols-12 lg:gap-16 lg:items-center">
                ...
                <div class="lg:col-span-6">
                    ...
                    <div class="hidden absolute top-0 end-0 translate-x-20 md:block lg:translate-x-20">
                        ...
                        <path d="M5 16.4754C11.7688 27.4499 21.2452 57.3224 5 89.0164" class="stroke-blue-400" stroke-width="10" stroke-linecap="round"/>
                        <path d="M33.6761 112.104C44.6984 98.1239 74.2618 57.6776 83.4821 5" class="stroke-blue-400" stroke-width="10" stroke-linecap="round"/>
                        <path d="M50.5525 130C68.2064 127.495 110.731 117.541 116 78.0874" class="stroke-blue-400" stroke-width="10" stroke-linecap="round"/>
                        </svg>
                    </div>
                    <!-- End SVG Element -->
                    </div>
